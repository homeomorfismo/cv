...
\begin{document}
    ...
    I'm interested in numerical methods and applied mathematics, specifically on the theoretical fundament of these.
	...
	\newline  \newline\noindent	
    %Currently working as a Givens Associate at Argonne National Laboratory.
    %Recent work on research concerns axisymmetric settings for linear elasticity and Stokes problem.
    Recent work on research concerns error control for elliptic eigenvalue constrained problems and preconditioners for the Stokes problem.
